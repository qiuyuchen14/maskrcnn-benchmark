...
_C.MODEL.COARSE_ON = False
_C.MODEL.DCOARSE_ON = False
_C.MODEL.REGRESSION_ON = False
_C.MODEL.BBOXFeature_ON= False
_C.MODEL.DBBOXFeature_ON= False
_C.MODEL.DEPTH_ON = False
_C.MODEL.RGB_ON = False
...
_C.MODEL.RESNETS.STEM_DIN_CHANNELS = 4
_C.MODEL.RESNETS.STEM_RGBDIN_CHANNELS = 4
