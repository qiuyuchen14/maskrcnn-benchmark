...
def do_kitchen_evaluation(
    ...
    if "poses" in iou_types:
        ...
        coco_results["poses"] = prepare_for_coco_pose(predictions, dataset)
...
def prepare_for_coco_detection(predictions, dataset):
    ...
    for image_id, prediction in enumerate(predictions):
        ...
        labels = torch.tensor(prediction.get_field("labels")).tolist()
...
#
#     accuracy = coco_gt.loadRes(str(json_result_file)) if coco_results else COCO()
#     return accuracy
...
class COCOResults(object):
    METRICS = {
        ...
        "poses": ["AP", "AP50", "AP75", "APs", "APm", "APl"],
        "box_proposal": [
            "AR@100",
            "ARs@100",
            "ARm@100",
    ...
    def __init__(self, *iou_types):
        allowed_types = ("box_proposal", "bbox", "segm", "poses", "keypoints")
